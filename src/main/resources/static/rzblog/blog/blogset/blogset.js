...
$(document).ready(function() {
	 ...
	 * document.getElementById("radio2").removeAttribute("checked"); if
	 * ($('#basicsetArticleEditor').val() == 1) { // markdown
	 * document.getElementById("radio1").removeAttribute("checked");
	 * document.getElementById("radio2").setAttribute("checked", true);
	 * $(".i-checks").iCheck({ checkboxClass : "icheckbox_square-green",
	 * radioClass : "iradio_square-green", }) } else { // html
	...
	// 初始化编辑器，更改为下拉框
	var articleEditore = $("#basicsetArticleEditor").select2();
	articleEditore.val($("#basicsetArticleEditor2").val()).trigger("change");
...
$("#form-blogset-basicset").validate({
	rules : {
		...
		basicsetFooterCopyrightInfo : {
			required : true,
			maxlength : 10000
		},
		basicsetFooterSiteStatement : {
			required : true,
			maxlength : 10000
		},
	},
...
function saveBasicset() {
	...
	var basicsetArticleEditor = $("#basicsetArticleEditor").val();
	...
	var basicsetOpenAppreciate = $("#basicsetOpenAppreciate").is(':checked') == true ? '0'
			: '1';
	var basicsetShowWeather = $("#basicsetShowWeather").is(':checked') == true ? '0'
			: '1';
	var basicsetOpenAnniversary = $("#basicsetOpenAnniversary").is(':checked') == true ? '0'
			: '1';
	var basicsetOpenCservice = $("#basicsetOpenCservice").is(':checked') == true ? '0'
			: '1';
	...
	var basicsetShowArticleSource = $("#basicsetShowArticleSource").is(
			':checked') == true ? '0' : '1';
	var basicsetShowAdvertisement = $("#basicsetShowAdvertisement").is(
			':checked') == true ? '0' : '1';
	var basicsetShowAdvertisementFlag = $("#basicsetShowAdvertisementFlag").is(
			':checked') == true ? '0' : '1';
	var basicsetAutomatiPushBaidu = $("#basicsetAutomatiPushBaidu").is(
			':checked') == true ? '0' : '1';
	...
	var basicsetFooterCopyrightInfo = $('#basicsetFooterCopyrightInfo').val();
	var basicsetFooterSiteStatement = $('#basicsetFooterSiteStatement').val();
	...
	$.ajax({
		...
		data : {
			...
			"basicsetShowWeather" : basicsetShowWeather,
			"basicsetOpenAnniversary" : basicsetOpenAnniversary,
			"basicsetOpenCservice" : basicsetOpenCservice,
			...
			"basicsetShowAdvertisement" : basicsetShowAdvertisement,
			"basicsetShowAdvertisementFlag" : basicsetShowAdvertisementFlag,
			"basicsetAutomatiPushBaidu" : basicsetAutomatiPushBaidu,
			...
			"basicsetFooterCopyrightInfo" : basicsetFooterCopyrightInfo,
			"basicsetFooterSiteStatement" : basicsetFooterSiteStatement,
...
function saveBlogset() {
	...
	var blogsetAdvertisementMaxShowNum = $('#blogsetAdvertisementMaxShowNum')
			.val();
	...
	$
			.ajax({
				...
				data : {
					...
					"blogsetAdvertisementMaxShowNum" : blogsetAdvertisementMaxShowNum,
...
function saveStyleset() {
	...
	var stylesetTitleStyle = $('#stylesetTitleStyle').val();
	...
	$.ajax({
		...
		data : {
			...
			"stylesetTitleStyle" : stylesetTitleStyle,
