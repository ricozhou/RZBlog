...
function setBackColor() {
	// 设置标题样式
	if(blogset.stylesetTitleStyle!=null&&blogset.stylesetTitleStyle!=''){
		document.getElementById("titleStyle").setAttribute("style",blogset.stylesetTitleStyle);
		document.getElementById("titleStyleL").setAttribute("style",blogset.stylesetTitleStyle);
	}
...
// : blogset.stylesetColor);
	...
	$(".nav li .sub-nav")
			.css(
					'background-color',
					(blogset.stylesetColor == null || blogset.stylesetColor == '') ? '#FFF'
							: blogset.stylesetColor);
	...
	// 侧边栏所有
	$(".sidebar .divside").css('border-radius', blogsRadius);
	$(".sidebarL .divside").css('border-radius', blogsRadius);
	// 关注我
	...
	// 弹窗
	$(".layui-layer").css('border-radius', blogsRadius / 1.5);
	$(".layui-layer-title").css('border-radius', blogsRadius / 1.5+'px '+blogsRadius / 1.5+'px 0 0');
	// 客服
	$(".cservice").css('border-radius', blogsRadius / 1.5);
