				...
				function() {
					...
					if (blogset.basicsetShowAdvertisement == 0
						...
						if (blogadvertisementList != null
							...
							// 添加
							document.getElementById('banner3L')
							...
							if (blogadvertisementList.length > 1) {
								...
								$('#banner3L').removeClass('fader3');
								$('#banner3L').addClass('fader33');
								// 左右按钮隐藏
								$('#banner3L .fader3_controls').css('display',
										'none');
							}
							// 设置是否显示广告标志
							...
							// 清除原有html
							var d1 = document.getElementById("sideradL");
