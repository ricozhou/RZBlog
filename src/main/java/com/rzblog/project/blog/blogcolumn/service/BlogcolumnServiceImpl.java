package com.rzblog.project.blog.blogcolumn.service;
...
import com.rzblog.project.blog.blogcolumn.mapper.BlogcolumnMapper;
...
public class BlogcolumnServiceImpl implements IBlogcolumnService {
	 ...
	 */
	@Override
	public int deleteBlogcolumnById(Integer blogColumnId, boolean delArticle) {
		if (delArticle) {
			return blogcolumnMapper.deleteBlogcolumnAndArticleById(blogColumnId);
		} else {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.rzblog.project.blog.blogcolumn.service.IBlogcolumnService#
