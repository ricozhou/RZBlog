package com.rzblog.project.blog.blogset.domain;
...
public class Blogset extends BaseEntity {
	...
	/** 是否显示天气 */
	private Integer basicsetShowWeather;
	/** 开启纪念功能 */
	private Integer basicsetOpenAnniversary;
	/** 开启客服功能 */
	private Integer basicsetOpenCservice;
	/** 文章允许下载 */
	...
	/** 显示广告 */
	private Integer basicsetShowAdvertisement;
	/** 显示广告标志 */
	private Integer basicsetShowAdvertisementFlag;
	/** 链接自动推送百度 */
	private Integer basicsetAutomatiPushBaidu;
	/** 评论自动审核 */
	...
	/** 底部版权信息 */
	private String basicsetFooterCopyrightInfo;
	/** 底部站点声明 */
	private String basicsetFooterSiteStatement;
	/** 基础设置备注 */
	...
	/** 每个位置最大广告数 */
	private Integer blogsetAdvertisementMaxShowNum;
	/** 主文章无图使用默认图片 */
	...
	// 今天的纪念日
	private List<Bloganniversary> bloganniversaryList = new ArrayList<Bloganniversary>();
	...
	/** 标题样式 */
	private String stylesetTitleStyle;
	/** 是否显示右侧边栏 */
	...
	public String getStylesetTitleStyle() {
		return stylesetTitleStyle;
	}

	public void setStylesetTitleStyle(String stylesetTitleStyle) {
		this.stylesetTitleStyle = stylesetTitleStyle;
	}

	public Integer getBasicsetAutomatiPushBaidu() {
		return basicsetAutomatiPushBaidu;
	}

	public void setBasicsetAutomatiPushBaidu(Integer basicsetAutomatiPushBaidu) {
		this.basicsetAutomatiPushBaidu = basicsetAutomatiPushBaidu;
	}

	public Integer getBasicsetShowAdvertisement() {
		return basicsetShowAdvertisement;
	}

	public void setBasicsetShowAdvertisement(Integer basicsetShowAdvertisement) {
		this.basicsetShowAdvertisement = basicsetShowAdvertisement;
	}

	public Integer getBasicsetShowAdvertisementFlag() {
		return basicsetShowAdvertisementFlag;
	}

	public void setBasicsetShowAdvertisementFlag(Integer basicsetShowAdvertisementFlag) {
		this.basicsetShowAdvertisementFlag = basicsetShowAdvertisementFlag;
	}

	public Integer getBlogsetAdvertisementMaxShowNum() {
		return blogsetAdvertisementMaxShowNum;
	}

	public void setBlogsetAdvertisementMaxShowNum(Integer blogsetAdvertisementMaxShowNum) {
		this.blogsetAdvertisementMaxShowNum = blogsetAdvertisementMaxShowNum;
	}

	public Integer getBasicsetOpenCservice() {
		return basicsetOpenCservice;
	}

	public void setBasicsetOpenCservice(Integer basicsetOpenCservice) {
		this.basicsetOpenCservice = basicsetOpenCservice;
	}

	public List<Bloganniversary> getBloganniversaryList() {
		return bloganniversaryList;
	}

	public void setBloganniversaryList(List<Bloganniversary> bloganniversaryList) {
		this.bloganniversaryList = bloganniversaryList;
	}

	public Integer getBasicsetOpenAnniversary() {
		return basicsetOpenAnniversary;
	}

	public void setBasicsetOpenAnniversary(Integer basicsetOpenAnniversary) {
		this.basicsetOpenAnniversary = basicsetOpenAnniversary;
	}

	public String getBasicsetFooterCopyrightInfo() {
		return basicsetFooterCopyrightInfo;
	}

	public void setBasicsetFooterCopyrightInfo(String basicsetFooterCopyrightInfo) {
		this.basicsetFooterCopyrightInfo = basicsetFooterCopyrightInfo;
	}

	public String getBasicsetFooterSiteStatement() {
		return basicsetFooterSiteStatement;
	}

	public void setBasicsetFooterSiteStatement(String basicsetFooterSiteStatement) {
		this.basicsetFooterSiteStatement = basicsetFooterSiteStatement;
	}

	public Integer getBasicsetShowWeather() {
		return basicsetShowWeather;
	}

	public void setBasicsetShowWeather(Integer basicsetShowWeather) {
		this.basicsetShowWeather = basicsetShowWeather;
	}
	...
	public String toString() {
		return "Blogset [blogSetId=" + blogSetId + ", basicsetTitle=" + basicsetTitle + ", basicsetWebsiteIco="
				...
				+ ", basicsetOpenAppreciate=" + basicsetOpenAppreciate + ", basicsetShowWeather=" + basicsetShowWeather
				+ ", basicsetOpenAnniversary=" + basicsetOpenAnniversary + ", basicsetOpenCservice="
				+ basicsetOpenCservice + ", basicsetOpenBlogDownload=" + basicsetOpenBlogDownload
				+ ", basicsetOpenNotice=" + basicsetOpenNotice + ", basicsetAutoLoading=" + basicsetAutoLoading
				+ ", basicsetShowArticleSource=" + basicsetShowArticleSource + ", basicsetShowAdvertisement="
				+ basicsetShowAdvertisement + ", basicsetShowAdvertisementFlag=" + basicsetShowAdvertisementFlag
				+ ", basicsetAutomatiPushBaidu=" + basicsetAutomatiPushBaidu + ", basicsetCommentAutoReview="
				+ basicsetCommentAutoReview + ", basicsetAddWaterMark=" + basicsetAddWaterMark
				+ ", basicsetWaterMarkMsg=" + basicsetWaterMarkMsg + ", basicsetWaterMarkSetMsg="
				+ basicsetWaterMarkSetMsg + ", basicsetAddCopyrightNotice=" + basicsetAddCopyrightNotice
				+ ", basicsetCopyrightNoticeInfo=" + basicsetCopyrightNoticeInfo + ", basicsetFooterCopyrightInfo="
				+ basicsetFooterCopyrightInfo + ", basicsetFooterSiteStatement=" + basicsetFooterSiteStatement
				...
				+ ", blogsetAdvertisementMaxShowNum=" + blogsetAdvertisementMaxShowNum + ", blogsetNoPicUseDefault="
				+ blogsetNoPicUseDefault + ", blogsetNoCoverpicUseContentpic=" + blogsetNoCoverpicUseContentpic
				+ ", blogsetDefaultPic=" + blogsetDefaultPic + ", blogsetFriendLinks=" + blogsetFriendLinks
				+ ", blogsetSidebarOtherMessage=" + blogsetSidebarOtherMessage + ", blogsetRemark=" + blogsetRemark
				+ ", createBy=" + createBy + ", createTime=" + createTime + ", updateBy=" + updateBy + ", updateTime="
				+ updateTime + ", bloggersetBloggerQqOrcodeUuidName=" + bloggersetBloggerQqOrcodeUuidName
				+ ", bloggersetBloggerQqGroupOrcodeUuidName=" + bloggersetBloggerQqGroupOrcodeUuidName
				+ ", bloggersetBloggerWechatOrcodeUuidName=" + bloggersetBloggerWechatOrcodeUuidName
				+ ", bloggersetBloggerWechatGroupOrcodeUuidName=" + bloggersetBloggerWechatGroupOrcodeUuidName
				...
				+ blogsiderbarList + ", bloganniversaryList=" + bloganniversaryList + ", stylesetColor=" + stylesetColor
				+ ", stylesetBackColor=" + stylesetBackColor + ", stylesetSmoothStyle=" + stylesetSmoothStyle
				+ ", stylesetTitleStyle=" + stylesetTitleStyle + ", stylesetShowRightSiderbar="
