package com.rzblog.project.blog.blogset.service;
...
import com.rzblog.project.blog.blogset.mapper.BlogsetMapper;
...
public class BlogsetServiceImpl implements IBlogsetService {
	...
	public Blogset getBlogsetMsg() {
		...
		if (list != null && list.size() > 0) {
			...
			// 查询获取今天的纪念日
			if (blogset.getBasicsetOpenAnniversary() == 0) {
				blogset.setBloganniversaryList(bloganniversaryService.selectBloganniversaryListByDate(new Date()));
			}
