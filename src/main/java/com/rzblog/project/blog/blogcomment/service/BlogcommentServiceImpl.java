...
import com.rzblog.project.blog.blogcomment.mapper.BlogcommentMapper;
...
public class BlogcommentServiceImpl implements IBlogcommentService {
	...
	public int[] addBlogcomment(Blogcomment blogcomment) {
		...
		if (basicsetCommentAutoReview == 0) {
			...
			// 更新文章表中评论数量(暂时无论是否通过都显示数量)
			blogcontentService.updateContentCommentNum(blogcomment.getShowId(), 0);
			// 插入数据库
	...
	public int deleteBlogcommentById(Integer blogCommentId, String showId) {
		// 更新文章表中评论数量(暂时无论是否通过都显示数量)
		blogcontentService.updateContentCommentNum(showId, 1);
	...
	public Integer selectAllBlogCommentNum() {
		return blogcommentMapper.selectAllBlogCommentNum();
	}
	...
	public Integer selectDayBlogCommentNum() {
		return blogcommentMapper.selectDayBlogCommentNum();
	}
	...
	public Integer selectMonthBlogCommentNum() {
		return blogcommentMapper.selectMonthBlogCommentNum();
	}
	...
	public Integer selectYearBlogCommentNum() {
		return blogcommentMapper.selectYearBlogCommentNum();
	}
	...
	public int selectDayBlogCommentNumPre() {
		return blogcommentMapper.selectDayBlogCommentNumPre();
	}
	...
	public int selectMonthBlogCommentNumPre() {
		return blogcommentMapper.selectMonthBlogCommentNumPre();
	}
	...
	public int selectYearBlogCommentNumPre() {
		return blogcommentMapper.selectYearBlogCommentNumPre();
	}
	...
	public Integer selectBlogCommentNumPreByDayNum(Integer dayNum) {
		return blogcommentMapper.selectBlogCommentNumPreByDayNum(dayNum);
	}
