package com.rzblog.project.blog.blogwebsite.service;
...
public class BlogwebsiteServiceImpl implements IBlogwebsiteService {
	...
	public List<Blogcontent> selectBlogCommonKeyListWithoutContent(Blogcontent blogcontent) {
		return blogcontentMapper.selectBlogCommonKeyListWithoutContent(blogcontent);
	}
	 ...
	 */
	@Override
	public int addBlogIndexNum(Long cid, Integer flag) {
		int rows = 0;
		if (flag == 0) {
			...
			rows = blogcontentMapper.updateDownloadNum(cid);
		}
		return rows;
	}
