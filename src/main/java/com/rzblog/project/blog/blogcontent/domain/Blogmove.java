...
import com.rzblog.framework.web.domain.RequestHeaderEntity;
...
public class Blogmove extends BaseEntity {
	...
	private String moveCookie;

	private RequestHeaderEntity requestHeader;

	public String getMoveCookie() {
		return moveCookie;
	}

	public void setMoveCookie(String moveCookie) {
		this.moveCookie = moveCookie;
	}
	...
	public String toString() {
		return "Blogmove [blogMoveId=" + blogMoveId + ", moveWebsiteId=" + moveWebsiteId + ", moveUserId=" + moveUserId
				...
				+ ", remark=" + remark + ", blogset=" + blogset + ", blogAuthor=" + blogAuthor + ", moveCookie="
				+ moveCookie + ", requestHeader=" + requestHeader + "]";
	}
