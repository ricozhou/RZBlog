...
import com.rzblog.common.utils.ThreadUtils;
import com.rzblog.common.utils.security.ShiroUtils;
import com.rzblog.implementspider.blogmove.controller.BlogMoveSpiderController;
import com.rzblog.implementspider.blogmove.controller.BlogMoveThread;
import com.rzblog.project.blog.blogcontent.mapper.BlogmoveMapper;
...
public class BlogmoveServiceImpl implements IBlogmoveService {
	...
	public boolean blogMoveStop(Blogmove blogMove) {
		...
		System.out.println(blogMove.getMoveMessage());
