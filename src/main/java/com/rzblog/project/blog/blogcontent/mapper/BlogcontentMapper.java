package com.rzblog.project.blog.blogcontent.mapper;
...
public interface BlogcontentMapper {
	...
	/**
	 * @date Nov 12, 2018 9:40:46 AM
	 * @Desc
	 * @param showId
	 * @return
	 */
	public int addContentCommentNum(String showId);

	/**
	 * @date Nov 12, 2018 9:40:52 AM
	 * @Desc
	 * @param showId
	 * @return
	 */
	public int subtractContentCommentNum(String showId);

	/**
	 * @date Nov 28, 2018 11:01:21 AM
	 * @Desc
	 * @param cid
	 * @return
	 */
	public int updateDownloadNum(Long cid);

	public List<Blogcontent> selectBlogCommonKeyListWithoutContent(Blogcontent blogcontent);
