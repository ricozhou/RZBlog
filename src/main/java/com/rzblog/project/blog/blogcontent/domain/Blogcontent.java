package com.rzblog.project.blog.blogcontent.domain;
...
public class Blogcontent extends BaseEntity {
	...
	/** 文章是类型，0是文章，1是软件，2是影视 */
	private Integer blogType;

	/** 立即推送百度 */
	private Integer nowPushBaidu;

	private Softcontent softcontent;
	// 开源软件显示模块
	/** 软件名 */
	...
	public Integer getNowPushBaidu() {
		return nowPushBaidu;
	}

	public void setNowPushBaidu(Integer nowPushBaidu) {
		this.nowPushBaidu = nowPushBaidu;
	}

	public Softcontent getSoftcontent() {
		return softcontent;
	}

	public void setSoftcontent(Softcontent softcontent) {
	...
	public String toString() {
		return "Blogcontent [cid=" + cid + ", showId=" + showId + ", blogFileName=" + blogFileName + ", title=" + title
				...
				+ likeNum + ", browseNum=" + browseNum + ", downloadNum=" + downloadNum + ", allowComment="
				+ allowComment + ", allowPing=" + allowPing + ", allowDownload=" + allowDownload + ", allowFeed="
				+ allowFeed + ", status=" + status + ", author=" + author + ", gtmCreate=" + gtmCreate
				+ ", gtmModified=" + gtmModified + ", showIntroduction=" + showIntroduction + ", introduction="
				+ introduction + ", privateArticle=" + privateArticle + ", blogColumnName=" + blogColumnName
				+ ", blogTagsName=" + blogTagsName + ", flag=" + flag + ", scrollRecommended=" + scrollRecommended
				+ ", specialRecommended=" + specialRecommended + ", recommended=" + recommended + ", articleEditor="
				+ articleEditor + ", articleSource=" + articleSource + ", articleTop=" + articleTop + ", blogtags="
				+ blogtags + ", tagsIds=" + tagsIds + ", blogType=" + blogType + ", nowPushBaidu=" + nowPushBaidu
				+ ", softcontent=" + softcontent + ", softName=" + softName + ", softType=" + softType
				+ ", softWebsite=" + softWebsite + ", softDownUrl=" + softDownUrl + ", softUpdateUrl=" + softUpdateUrl
				+ ", softDocUrl=" + softDocUrl + ", softLicense=" + softLicense + ", softLanguage=" + softLanguage
				+ ", softOperateSystem=" + softOperateSystem + ", softAuthor=" + softAuthor + "]";
	}
