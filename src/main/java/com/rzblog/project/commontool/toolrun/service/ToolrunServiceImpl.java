package com.rzblog.project.commontool.toolrun.service;
...
import com.rzblog.common.constant.CodingConstant;
...
import com.rzblog.common.utils.JsonUtils;
...
import com.rzblog.project.commontool.toolmanage.domain.Toolmanage;
import com.rzblog.project.commontool.toolmanage.domain.Toolset;
import com.rzblog.project.commontool.toolmanage.service.IToolmanageService;
import com.rzblog.project.commontool.toolmanage.service.IToolsetService;
import com.rzblog.project.commontool.toolrun.domain.CobeImage;
import com.rzblog.project.commontool.toolrun.domain.CommonToolEntity;
import com.rzblog.project.commontool.toolrun.domain.FormatText;
import com.rzblog.project.commontool.toolrun.domain.GifMsg;
import com.rzblog.project.commontool.toolrun.domain.ImgToChar;
import com.rzblog.project.commontool.toolrun.domain.MatchRegularExpression;
import com.rzblog.project.commontool.toolrun.domain.ORCode;
import com.rzblog.project.commontool.toolrun.utils.BaiDuOCRReadUtil;
import com.rzblog.project.commontool.toolrun.utils.ToolrunUtils;
...
public class ToolrunServiceImpl implements IToolrunService {
	...
	public String runOCRRead(CommonToolEntity commonToolEntity) {
		...
		try {
			...
			// 读取其他设置信息
			Toolset toolset = toolsetService.selectToolsetById(1);
