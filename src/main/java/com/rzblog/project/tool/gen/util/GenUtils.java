package com.rzblog.project.tool.gen.util;

import java.util.ArrayList;
import java.util.List;
import org.apache.velocity.VelocityContext;
import com.rzblog.common.constant.CommonConstant;
import com.rzblog.common.constant.CommonMap;
import com.rzblog.common.utils.DateUtils;
import com.rzblog.common.utils.StringUtils;
import com.rzblog.framework.config.GenConfig;
import com.rzblog.project.tool.gen.domain.ColumnInfo;
import com.rzblog.project.tool.gen.domain.TableInfo;
...
{
    /** 项目空间路径 */
    private static final String projectPath = "main/java/com/rzblog/project";
    ...
    /** js空间路径 */
    private static final String javascriptPath = "main/resources/static/rzblog/";
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println(getModuleName("com.rzblog.project.system"));
    }
}
