package com.rzblog.project.system.website.domain;
...
public class Website extends BaseEntity {
	...
	/** 百度链接提交token */
	private String websiteBaiduToken;
	/** 网站公网IP */
	...
	public String toString() {
		return "Website [websiteId=" + websiteId + ", websiteTitleName=" + websiteTitleName + ", websiteIco="
				...
				+ ", websiteBaiduToken=" + websiteBaiduToken + ", websitePublicIp=" + websitePublicIp
				+ ", websitePublicPort=" + websitePublicPort + ", websiteCopyrightInformation="
				+ websiteCopyrightInformation + ", websiteMailSmtpUrl=" + websiteMailSmtpUrl + ", websiteMailSmtpPort="
				+ websiteMailSmtpPort + ", websiteMailSenderMailbox=" + websiteMailSenderMailbox
				+ ", websiteMailSenderNickname=" + websiteMailSenderNickname + ", websiteMailSenderPassword="
				+ websiteMailSenderPassword + ", createBy=" + createBy + ", createTime=" + createTime + ", updateBy="
				+ updateBy + ", updateTime=" + updateTime + ", remark=" + remark + "]";
	}

	public String getWebsiteBaiduToken() {
		return websiteBaiduToken;
	}

	public void setWebsiteBaiduToken(String websiteBaiduToken) {
		this.websiteBaiduToken = websiteBaiduToken;
	}
