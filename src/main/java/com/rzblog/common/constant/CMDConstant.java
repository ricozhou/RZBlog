...
//	public static final String CMD_COMMAND_PYTHON_3 = "python -c \"from\" \"distutils.sysconfig\" \"import\" \"get_python_lib; print get_python_lib()\"";
	 ...
	 * 通用CMD
	 */
	public static final String CMD_COMMAND_NODE_WIN_NPM_1 = "npm.cmd init -y";
	/**
	 * 通用CMD
	 */
	public static final String CMD_COMMAND_NODE_NPM_1 = "npm init -y";
	/**
	 * 通用CMD
	 */
	public static final String CMD_COMMAND_NODE_WIN_NPM_2 = "npm.cmd install ";
	/**
	 * 通用CMD
	 */
	public static final String CMD_COMMAND_NODE_NPM_2 = "npm install ";
	/**
	 * 通用CMD
	 */
