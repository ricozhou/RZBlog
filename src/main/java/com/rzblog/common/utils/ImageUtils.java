...
import com.rzblog.project.common.image.gifdecoder.AnimatedGifEncoder;
import com.rzblog.project.common.image.gifdecoder.GifDecoder;
...
public class ImageUtils {
	...
	public static boolean GenerateImageByBase64(String base64str, String savepath) {
		...
		String baseValue = base64str.replaceAll(" ", "+");// 前台在用Ajax传base64值的时候会把base64中的+换成空格，所以需要替换回来。
