...
import com.rzblog.common.exception.file.FileNameLengthLimitExceededException;
...
public class FileUploadUtils {
	...
	// 默认头像地址
	private static String defaultProfileBaseDir = new File(FilePathConfig.getUploadProfilePath()).getAbsolutePath();
	// 默认通用工具地址
